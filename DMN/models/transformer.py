...
if __name__ == "__main__":
    ...
    dim_head = 32
    dropout = 0.0
    x1 = torch.rand(16, 36, 512)
    x2 = torch.rand(16, 36, 512)
    Encoder = TransformerEncoder(dim, en_depth, heads, dim_head, mlp_dim, dropout)
    Decoder = TransformerDecoder(dim, de_depth, heads, dim_head, mlp_dim, dropout)
    sr = Encoder(x1)
    print(sr.size())
    sr = Decoder(x2, sr)
    print(sr.size())
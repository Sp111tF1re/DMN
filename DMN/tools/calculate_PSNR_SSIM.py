...
def calc(step):
    ...
    folder_GT = 'C:/ghp/Domin-migration_related/paired_part/SRFBN_brain_x4/data/dataset_test/HR'
    folder_Gen = 'D:/results/paired_part/x4/SRFBN/original'
    folder_Gen = os.path.join(folder_Gen, "epoch_"+str(step))
    ...
    write(psnr=sum(PSNR_all) / len(PSNR_all), ssim=sum(SSIM_all) / len(SSIM_all), step=step)
